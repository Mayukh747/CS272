...
class MDP:
    ...
    def __init__(self, config_path: str) -> None:
        ...
        Raises:
f            ValueError: If a transition probability is invalid (the sum not equal to 1.0), raise an error. (Use __verify_probs function)
        """
        try:
    ...
    def T(self, state: str, action: str) -> list:
        ...
        Returns:
            list[(str,float)]: a list of probabilities to all possible
            successor states e.g. [("0", 0.1), ("2", 0.3), ("3", 0.6)]
        """
